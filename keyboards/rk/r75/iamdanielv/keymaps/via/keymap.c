...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN_FN_LYR] = LAYOUT( // 1
        ...
        MY_GRV,    MY_CONS,   MY_TASK,   C(KC_F),   C(KC_R),   _______,  KC_PGUP,  KC_HOME,  KC_UP,     KC_END,   KC_PSCR,    KC_SCRL,  KC_PAUS,  KC_INS,    KC_SCRL,
    ...
    [_NAV_LYR] = LAYOUT( // 4
        ...
        MY_GRV,    MY_CONS,   MY_TASK,   C(KC_F),   C(KC_R),   _______,  KC_PGUP,  KC_HOME,  KC_UP,    KC_END,   KC_PSCR,    KC_SCRL,  KC_PAUS,  KC_INS,    _______,
    ...
    [_FN_LYR] = LAYOUT( // 5
        KC_GRV,    KC_F1,     KC_F2,     KC_F3,     KC_F4,     KC_F5,    KC_F6,    KC_F7,    KC_F8,     KC_F9,    KC_F10,     KC_F11,   KC_F12,   KC_DEL,   KC_MUTE,
        _______,   _______,   _______,   _______,   _______,   _______,  _______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,    KC_VOLD,  KC_VOLU,  KC_DEL,    TG_NAV,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (!process_fn_mode(keycode, record)) {
        return false;
    }
